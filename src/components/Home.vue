  ...
  <div v-if="reload">
    ...
    <el-container>
      ...
      <el-container>
        <el-aside style="width: 100px" :style="{ background: bg_sw ? '#ffffff+00' : '#333' }">
          <el-col>
            <el-menu style="border: none" default-active="1" class="el-menu-vertical-demo" background-color="#00000000"
              ...
              <el-row id="Sun">
                <el-button type="info" circle @click="setbg">
                  <el-icon>
                    <Orange />
                  </el-icon>
                </el-button>
              ...
              ">
                <el-icon>
                  <Clock />
                </el-icon> <span slot="title">更新</span>
              </el-menu-item>
              <el-menu-item index="4" @click="item = 3">
                <el-icon>
                  <Apple />
                </el-icon> <span slot="title">时间表</span>
              </el-menu-item>
        ...
        <el-main :style="{ background: bg_sw ? '#ffffff+00' : '#333' }" id="Main">
    ...
    goTop() {
      ...
      const timeTop = setInterval(() => {
        document.querySelector(
          ...
          document.querySelector(
            "#app > div > section > section > main > div"
          ).scrollTop =
          top -=
          50;
        if (top <= 0) {
